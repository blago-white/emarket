...
function uploadNewPhoto(event) {
    ...
    changePhotoLabel.innerHTML = "uploaded " + "<span style='font-weight: 100;max-width: 14ch;display: inline-flex;overflow: hidden;text-wrap: nowrap;'>" + event.target.files[0].name + "</span>";
